...
const String tbrAppName = "The Book Recommendation";
const String tbrAppTagLine = "Read and Recommend";


const String tWelcomeTitle = "The Book Recommendation";
const String tWelcomeSubTitle = "Unlocking Worlds, One Page at a Time: The Book Recommendation Revolution";
